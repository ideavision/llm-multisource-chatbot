...
import { PayseraiDocument } from "@/lib/search/interfaces";
...
export const AIMessage = ({
  ...
  query?: string;
  citedDocuments?: [string, PayseraiDocument][] | null;
  isComplete?: boolean;
  hasDocs?: boolean;
  ...
  return (
    <div className={"py-5 px-5 flex -mr-6 w-full"}>
      <div className="mx-auto w-searchbar-xs 2xl:w-searchbar-sm 3xl:w-searchbar relative">
        <div className="ml-8">
          <div className="flex">
            <div className="p-1 bg-ai rounded-lg h-fit my-auto bg-green-200">
              <div className="text-inverted">
                <FiCheck size={22} className="my-auto mx-auto" />
              </div>
            </div>

            <div className="font-bold text-emphasis ml-2 my-auto">PayserAi</div>
  ...
  return (
    <div className="py-5 px-5 flex -mr-6 w-full">
      <div className="mx-auto w-searchbar-xs 2xl:w-searchbar-sm 3xl:w-searchbar">
        <div className="ml-8">
          <div className="flex">
            <div className=" p-1 bg-ai rounded-lg h-fit my-auto bg-blue-200">
              <div className="text-inverted">
                <FiUser size={22} className="my-auto bg-blue-200 mx-auto " />
              </div>
            </div>
