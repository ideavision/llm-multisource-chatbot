...
export default function Page() {
  ...
  return (
    <div className="mx-auto container">
      ...
      <Text>
        Connect Payserai to your organization&apos;s knowledge sources.
        We&apos;ll automatically sync your data into Payserai, so you can find
      ...
      <Text>
        ...
        pull in the latest updates from the source every 5 days.
      </Text>
      <div className="flex flex-wrap gap-4 p-4">
