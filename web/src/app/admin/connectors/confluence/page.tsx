      ...
      {confluenceCredential ? (
        ...
        <>
          <Text>
            ...
            <a
              className="text-link"
              href="https://intranet.paysera.net/"
              target="_blank"
            >
              here
            </a>{" "}
      ...
      {confluenceCredential ? (
        <>
          <p className="text-sm mb-4">
            ...
            entering{" "}
            <i>
              https://payserai.atlassian.net/wiki/spaces/Engineering/overview
            </i>{" "}
            ...
            <ConnectorForm<ConfluenceConfig>
              ...
              validationSchema={Yup.object().shape({
                wiki_page_url: Yup.string().required(
                  "Please enter any link to your confluence e.g. https://payserai.atlassian.net/wiki/spaces/Engineering/overview"
                ),
              })}
              initialValues={{
                wiki_page_url: "",
              }}
              refreshFreq={60 * 60 * 60} // 3600 minutes
