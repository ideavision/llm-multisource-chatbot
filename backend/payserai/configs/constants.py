...
# Messages
DISABLED_GEN_AI_MSG = (
    "Your System Admin has disabled the Generative AI functionalities of Payserai.\n"
    "Please contact them if you wish to have this enabled.\n"
    "You can still use Payserai as a search engine."
)


class DocumentSource(str, Enum):
    # Special case, document passed in via Payserai APIs without specifying a source type
