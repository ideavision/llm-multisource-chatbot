...
# Payserai custom Deep Learning Models
...
# Additionally Payserai supports GPT4All and custom request library based models
...
# If using Azure, it's the engine name, for example: Payserai
...
# API Base, such as (for Azure): https://payserai.openai.azure.com/
