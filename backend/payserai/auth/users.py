...
from payserai.configs.app_configs import DISABLE_AUTH
from payserai.configs.app_configs import REQUIRE_EMAIL_VERIFICATION
from payserai.configs.app_configs import SECRET
from payserai.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from payserai.configs.app_configs import SMTP_PASS
from payserai.configs.app_configs import SMTP_PORT
from payserai.configs.app_configs import SMTP_SERVER
from payserai.configs.app_configs import SMTP_USER
from payserai.configs.app_configs import VALID_EMAIL_DOMAINS
from payserai.configs.app_configs import WEB_DOMAIN
from payserai.configs.constants import AuthType
from payserai.db.auth import get_access_token_db
from payserai.db.auth import get_user_count
from payserai.db.auth import get_user_db
from payserai.db.engine import get_session
from payserai.db.models import AccessToken
...
USER_WHITELIST_FILE = "/home/payserai_whitelist.txt"
...
def send_user_verification_email(user_email: str, token: str) -> None:
    msg = MIMEMultipart()
    msg["Subject"] = "Payserai Email Verification"
    msg["To"] = user_email
...
async def current_user(
    ...
    double_check_user = fetch_versioned_implementation(
        "payserai.auth.users", "double_check_user"
    )
