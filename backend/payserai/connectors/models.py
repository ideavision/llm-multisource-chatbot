...
from payserai.utils.text_processing import make_url_compatible
...
class DocumentBase(BaseModel):
    """Used for Payserai ingestion api, the ID is inferred before use if not provided"""
    ...
    # different because  message may display as #general but general should not be part
