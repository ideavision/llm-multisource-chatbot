...
from payserai.chat.process_message import stream_chat_message
from payserai.db.chat import create_chat_session
from payserai.db.chat import delete_chat_session
from payserai.db.chat import get_chat_message
from payserai.db.chat import get_chat_messages_by_session
from payserai.db.chat import get_chat_session_by_id
from payserai.db.chat import get_chat_sessions_by_user
from payserai.db.chat import set_as_latest_chat_message
from payserai.db.chat import translate_db_message_to_chat_message_detail
from payserai.db.chat import update_chat_session
from payserai.db.engine import get_session
from payserai.db.feedback import create_chat_message_feedback
...
from payserai.secondary_llm_flows.chat_session_naming import (
    get_renamed_conversation_name,
)
from payserai.server.query_and_chat.models import ChatFeedbackRequest
from payserai.server.query_and_chat.models import ChatMessageIdentifier
from payserai.server.query_and_chat.models import ChatRenameRequest
from payserai.server.query_and_chat.models import ChatSessionCreationRequest
from payserai.server.query_and_chat.models import ChatSessionDetailResponse
from payserai.server.query_and_chat.models import ChatSessionDetails
from payserai.server.query_and_chat.models import ChatSessionsResponse
from payserai.server.query_and_chat.models import CreateChatMessageRequest
from payserai.server.query_and_chat.models import CreateChatSessionID
from payserai.server.query_and_chat.models import RenameChatSessionResponse
from payserai.server.query_and_chat.models import SearchFeedbackRequest
...
def get_chat_session(
    ...
    return ChatSessionDetailResponse(
        ...
        passist_id=chat_session.passist_id,
        messages=[
...
def create_new_chat_session(
    ...
    try:
        new_chat_session = create_chat_session(
            ...
            user_id=user_id,
            passist_id=chat_session_creation_request.passist_id,
        )
    except Exception as e:
        logger.exception(e)
        raise HTTPException(status_code=400, detail="Invalid Passist provided.")
