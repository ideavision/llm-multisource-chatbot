...
from payserai.background.celery.celery_utils import get_deletion_status
from payserai.configs.constants import DocumentSource
from payserai.connectors.file.utils import write_temp_files

from payserai.db.connector import create_connector
from payserai.db.connector import delete_connector
from payserai.db.connector import fetch_connector_by_id
from payserai.db.connector import fetch_connectors
from payserai.db.connector import get_connector_credential_ids
from payserai.db.connector import update_connector
from payserai.db.connector_credential_pair import get_connector_credential_pairs
from payserai.db.credentials import create_credential
from payserai.db.credentials import delete_google_drive_service_account_credentials
from payserai.db.credentials import fetch_credential_by_id
from payserai.db.deletion_attempt import check_deletion_attempt_is_allowed
from payserai.db.document import get_document_cnts_for_cc_pairs
from payserai.db.engine import get_session
from payserai.db.index_attempt import create_index_attempt
from payserai.db.index_attempt import get_latest_index_attempts
from payserai.db.models import User
from payserai.dynamic_configs.interface import ConfigNotFoundError
from payserai.server.documents.models import AuthStatus
from payserai.server.documents.models import AuthUrl
from payserai.server.documents.models import ConnectorBase
from payserai.server.documents.models import ConnectorCredentialPairIdentifier
from payserai.server.documents.models import ConnectorIndexingStatus
from payserai.server.documents.models import ConnectorSnapshot
from payserai.server.documents.models import CredentialSnapshot
from payserai.server.documents.models import FileUploadResponse
from payserai.server.documents.models import GDriveCallback
from payserai.server.documents.models import GoogleAppCredentials
from payserai.server.documents.models import GoogleServiceAccountCredentialRequest
from payserai.server.documents.models import GoogleServiceAccountKey
from payserai.server.documents.models import IndexAttemptSnapshot
from payserai.server.documents.models import ObjectCreationIdResponse
from payserai.server.documents.models import RunConnectorRequest
...
def upsert_service_account_credential(
    ...
    # `user=None` since this credential is not a passistl credential
