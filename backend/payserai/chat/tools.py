...
from payserai.prompts.chat_tools import PAYSERAI_TOOL_DESCRIPTION
from payserai.prompts.chat_tools import PAYSERAI_TOOL_NAME
from payserai.prompts.chat_tools import TOOL_FOLLOWUP
from payserai.prompts.chat_tools import TOOL_LESS_FOLLOWUP
from payserai.prompts.chat_tools import TOOL_LESS_PROMPT
from payserai.prompts.chat_tools import TOOL_TEMPLATE
from payserai.prompts.chat_tools import USER_INPUT
...
def call_tool(
    model_actions: PayseraiChatModelOut,
) -> str:
...
def form_tool_section_text(
    ...
    if retrieval_enabled and tools:
        tools.append(
            {"name": PAYSERAI_TOOL_NAME, "description": PAYSERAI_TOOL_DESCRIPTION}
        )
