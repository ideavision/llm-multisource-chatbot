...
from payserai.configs.model_configs import GEN_AI_API_KEY
...
def translate_payserai_msg_to_langchain(msg: ChatMessage) -> BaseMessage:
...
def translate_history_to_basemessages(
    ...
    history_basemessages = [
        translate_payserai_msg_to_langchain(msg)
        for msg in history
