...
from payserai.configs.app_configs import LOG_ALL_MODEL_INTERACTIONS
from payserai.configs.model_configs import GEN_AI_API_ENDPOINT
from payserai.configs.model_configs import GEN_AI_API_VERSION
from payserai.configs.model_configs import GEN_AI_LLM_PROVIDER_TYPE
...
from payserai.configs.model_configs import GEN_AI_TEMPERATURE
from payserai.llm.interfaces import LLM
from payserai.llm.utils import message_generator_to_string_generator
from payserai.llm.utils import should_be_verbose
...
def _get_model_str(
    ...
    # User specified something wrong, just use Payserai default
