...
from payserai.chat.chat_utils import combine_message_chain
from payserai.configs.chat_configs import DISABLE_LLM_CHOOSE_SEARCH
...
from payserai.llm.utils import translate_payserai_msg_to_langchain
from payserai.prompts.chat_prompts import AGGRESSIVE_SEARCH_TEMPLATE
from payserai.prompts.chat_prompts import NO_SEARCH
from payserai.prompts.chat_prompts import REQUIRE_SEARCH_HINT
from payserai.prompts.chat_prompts import REQUIRE_SEARCH_SYSTEM_MSG
from payserai.prompts.chat_prompts import SKIP_SEARCH
...
def check_if_need_search_multi_message(
    ...
    prompt_msgs.extend([translate_payserai_msg_to_langchain(msg) for msg in history])
...
def check_if_need_search(
    ...
    if llm is None:
        try:
            ...
            # If Generative AI is turned off the always run Search as Payserai is being used
