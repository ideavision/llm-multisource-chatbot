...
from payserai.db.connector import fetch_unique_document_sources
...
from payserai.prompts.constants import SOURCES_KEY
from payserai.prompts.filter_extration import FILE_SOURCE_WARNING
from payserai.prompts.filter_extration import SOURCE_FILTER_PROMPT
from payserai.prompts.filter_extration import WEB_SOURCE_WARNING
...
def extract_source_filter(
    ...
    def _get_source_filter_messages(
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": "What page from Payserai contains debugging instruction on segfault",
            },
            {
                "role": "assistant",
                "content": json.dumps({SOURCES_KEY: None}),
