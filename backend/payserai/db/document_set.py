...
from payserai.db.models import DocumentSet__ConnectorCredentialPair
...
def get_or_create_document_set_by_name(
    ...
    document_set_description: str = "Default Passist created Document-Set, "
    "please update description",
) -> DocumentSetDBModel:
    """This is used by the default passists which need to attach to document sets
    on server startup"""
