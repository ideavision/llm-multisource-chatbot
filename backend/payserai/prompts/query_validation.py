...
{QUESTION_PAT.upper()} Payserai is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to Payserai being unreachable. \
Assuming the documents from search contains situations where Payserai is not reachable and \
