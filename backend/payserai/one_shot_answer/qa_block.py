...
from payserai.chat.chat_utils import build_context_str
...
from payserai.llm.utils import check_number_of_tokens
from payserai.llm.utils import get_default_llm_token_encode
from payserai.one_shot_answer.interfaces import QAModel
from payserai.one_shot_answer.qa_utils import process_answer
from payserai.one_shot_answer.qa_utils import process_model_tokens
from payserai.prompts.direct_qa_prompts import CONTEXT_BLOCK
from payserai.prompts.direct_qa_prompts import COT_PROMPT
from payserai.prompts.direct_qa_prompts import HISTORY_BLOCK
from payserai.prompts.direct_qa_prompts import JSON_PROMPT
from payserai.prompts.direct_qa_prompts import LANGUAGE_HINT
from payserai.prompts.direct_qa_prompts import ONE_SHOT_SYSTEM_PROMPT
from payserai.prompts.direct_qa_prompts import ONE_SHOT_TASK_PROMPT
from payserai.prompts.direct_qa_prompts import PARAMATERIZED_PROMPT
from payserai.prompts.direct_qa_prompts import PARAMATERIZED_PROMPT_WITHOUT_CONTEXT
from payserai.prompts.direct_qa_prompts import WEAK_LLM_PROMPT
from payserai.prompts.direct_qa_prompts import WEAK_MODEL_SYSTEM_PROMPT
from payserai.prompts.direct_qa_prompts import WEAK_MODEL_TASK_PROMPT
from payserai.utils.logger import setup_logger
from payserai.utils.text_processing import clean_up_code_blocks
from payserai.utils.text_processing import escape_newlines
...
class WeakLLMQAHandler(QAHandler):
    """Since Payserai supports a variety of LLMs, this less demanding prompt is provided
...
def no_gen_ai_response() -> Iterator[PayseraiAnswerPiece]:
    ...
    def answer_question_stream(
        ...
        try:
            for answer_piece in self._qa_handler.process_llm_token_stream(
                ...
                if (
                    isinstance(answer_piece, PayseraiAnswerPiece)
