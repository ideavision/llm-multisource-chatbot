...
from payserai.configs.app_configs import MODEL_SERVER_ALLOWED_HOST
...
def get_model_app() -> FastAPI:
    application = FastAPI(title="Payserai Model Server", version=__version__)
...
if __name__ == "__main__":
    logger.info(
        f"Starting Payserai Model Server on http://{MODEL_SERVER_ALLOWED_HOST}:{str(MODEL_SERVER_PORT)}/"
    )
