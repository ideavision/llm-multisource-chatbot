...
from payserai.search.search_nlp_models import get_intent_model_tokenizer
from payserai.search.search_nlp_models import get_local_intent_model
...
def warm_up_intent_model() -> None:
    ...
    inputs = intent_tokenizer(
        "payserai", return_tensors="tf", truncation=True, padding=True
    )
